...
export const products: Product[] = [
  ...
  },
  {
    id: 4,
    name: "Pastel de Yuca",
    description: "Pastelito de yuca relleno de queso, crujiente por fuera y suave por dentro",
    price: 2.75,
    imageUrl: "https://images.pexels.com/photos/4553039/pexels-photo-4553039.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
    category: "pasteles",
    popular: true,
